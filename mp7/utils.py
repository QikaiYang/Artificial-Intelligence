...
def hyperparameters():
    ...
    parser.add_argument('--epsilon', type=float, default=0.55, help='exploration parameter')
...
def rollout(env: gym.Env, policies: policies.QPolicy, episodes: int, epsilon: float, render: bool = False):
    ...
    for _ in range(episodes):
        ...
        while not done:
            ...
            action = (pi.tolist()).index(1) if 1 in pi else np.random.choice([0,1])
            ### Your Code Ends >>>
